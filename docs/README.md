...
| [`SUBMISSION_BLOCKERS.md`](SUBMISSION_BLOCKERS.md) | Current submission blockers snapshot for public repo, Loom, hosted proof, release evidence, platform rate limits, backend, media, and live-data boundaries. |
| [`SUBMISSION_COMMAND_TRANSCRIPT_TEMPLATE.md`](SUBMISSION_COMMAND_TRANSCRIPT_TEMPLATE.md) | Paste-safe validation transcript template with redaction rules and separate local, hosted, live, provider, and release-evidence sections. |
