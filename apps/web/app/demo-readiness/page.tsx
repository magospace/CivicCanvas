        ...
        <div className="grid gap-4 lg:grid-cols-3">
          ...
          <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-panel">
            ...
            <p className="mt-4 text-sm leading-6 text-slate-600">
              v0.6, v0.7, and v0.8 remain untagged until a public URL passes hosted smoke,
              remote Playwright, and platform-level firewall/rate-limit review.
            </p>
        ...
        <section className="mt-6 rounded-lg border border-slate-200 bg-white p-5 shadow-panel">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-md border border-slate-200 bg-civic-50 p-4">
              ...
              <p className="mt-2 text-xs leading-5 text-slate-600">
                Houston transportation is the default v0.9 candidate, but it remains coming-later until
                catalog metadata, field classification, local fallback samples, caveats, adapter mapping,
                and bounded query tests are complete.
              </p>
            </div>
          </div>
        </section>
