...
describe("dashboard generation", () => {
  it("generates the Dallas demo dashboard", () => {
    const generation = generateCanvasForPrompt("Show Dallas 311 service requests by category and ZIP code for 2024.");
  ...
  it("generates the Austin demo dashboard", () => {
    const generation = generateCanvasForPrompt("Show Austin building permits by month and ZIP code.");
  ...
  it("returns dataset suggestions for unsupported prompts", () => {
    const generation = generateCanvasForPrompt("Compare tax abatements across El Paso.");
  ...
  it("exports a preview-only Miro spec with source method frame", () => {
    const generation = generateCanvasForPrompt("Show Dallas 311 service requests by category and ZIP code for 2024.");
